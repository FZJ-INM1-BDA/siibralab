classdef API
    ...
    methods (Static)
        ...
        function absolutLink = regionMap(atlasId, parcellationId, regionName, spaceId, mapOrInfo, mapType)
            relativeLink = strcat( ...
                "atlases/", atlasId, ...
                ...
                "?space_id=", spaceId, ...
                "&map_type=", mapType);
            absolutLink = siibra.internal.API.absoluteLink(relativeLink);
        end
        
        function absolutLink = parcellationMap(atlasId, spaceId, parcellationId)
            relativeLink = strcat( ...
                "atlases/", atlasId, ...
                "/spaces/", spaceId, ...
